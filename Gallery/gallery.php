                    ...
                    <form action="gallery_delete.php" method="POST">
                        <table id="test" class="table table-striped table-sm">
                            ...
                            <tbody>
                                <?php
                                include "../conn.php";
                                $SQL = "SELECT * FROM gallery_view"; //sintak sql
                                $result = mysqli_query($koneksi, $SQL); //menjalankan sql
                                foreach ($result as $row) {
                                    echo ("<tr>");
                                    echo ('<td><input name="ids[]" type="checkbox" value="' . $row["gallery_id"] . '"></td>');
                        ...
                        <center>
                                <input type="submit" class="btn btn-outline-danger" value="Bulk Delete">
                        </center>
                    </form>
                </div>
            </main>
