			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				...
				<form action="users_process.php" method="POST" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="tit" class="col-sm-2 col-form-label">Username ID</label>
						<div class="col-sm-10">
							<input type="text" name="id" class="form-control" id="id" placeholder="Masukan Username ID">
						</div>
					</div>
					<div class="form-group row">
						<label for="tit" class="col-sm-2 col-form-label">Username</label>
						<div class="col-sm-10">
							<input type="text" name="user" class="form-control" id="user" placeholder="Masukan Username">
						</div>
					</div>
					<div class="form-group row">
						<label for="desc" class="col-sm-2 col-form-label">Password Baru</label>
						<div class="col-sm-10">
					...
					<div class="form-group row" hidden>
						...
						<div class="col-sm-10">
							<input type="text" name="role" class="form-control" value="admin" id="role">
						</div>
					</div>
