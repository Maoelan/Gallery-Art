                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group mr-2">
                            <a href="artist_insert.php" type="button" class="btn btn-sm btn-outline-secondary">Insert Data</a>
                        </div>
                    ...
                    <table id="test" class="table table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                echo ('<td>');
                                echo ('<a href="artist_update.php?id=' . $row["artist_id"] . '"> Edit </a> ||');
                                echo ('<a href="artist_delete.php?id=' . $row["artist_id"] . '"> Hapus </a> ');
                                echo ('</td>');
                                echo ("</tr>");
                            }
                            ?>
