			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				...
				<form action="gallery_process.php" method="POST" enctype="multipart/form-data">
					<div class="form-group row">
						...
						<div class="col-sm-10">
							<input type="text" hidden name="nama_old" value="<?php echo $data['gallery_image']; ?>">
							<input type="text" hidden name="id" value="<?php echo $data['gallery_id']; ?>">
							<input type="text" name="title" class="form-control" id="tit" placeholder="Arts title" value="<?php echo $data['gallery_name']; ?>">
						</div>
					</div>
					<div class="form-group row">
						<label for="desc" class="col-sm-2 col-form-label">Desc</label>
						<div class="col-sm-10">
							<input type="text" name="desc" class="form-control" id="desc" placeholder="Arts description" value="<?php echo $data['gallery_desc']; ?>">
						</div>
					</div>
					<div class="form-group row">
					...
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<option value="" disabled selected>Pilih Artist</option>
								...
								?>
									<option <?php echo (int) $data['artist_id'] == $row['artist_id'] ? 'selected' : ''?>  value="<?=$row['artist_id']?>"><?=$row['artist_name']?></option>
								<?php } ?>
							</select>
						</div>
					</div>
					<div class="form-group row">
						...
						<div class="col-sm-10">
							...
							<option value="" disabled selected>Pilih Types</option>
								...
								foreach ($result as $row) {
								?>
									<option <?php echo (int) $data['types_id'] == $row['types_id'] ? 'selected' : ''?> value="<?=$row['types_id']?>"><?=$row['types_name']?></option>
								<?php } ?>
							</select>
						</div>
					</div>
