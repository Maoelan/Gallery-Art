			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				...
				<form action="artist_process.php" method="POST" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="tit" class="col-sm-2 col-form-label">Artist ID</label>
						<div class="col-sm-10">
							<input type="text" name="id" class="form-control" id="id" placeholder="Masukan Artist ID">
						</div>
					</div>
					<div class="form-group row">
						<label for="tit" class="col-sm-2 col-form-label">Artist Name</label>
						<div class="col-sm-10">
							<input type="text" name="name" class="form-control" id="user" placeholder="Masukan Artist Name">
						</div>
					</div>
