                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                    ...
                    <div class="btn-toolbar mb-2 mb-md-0">
                        <div class="btn-group mr-2">
                            <a href="users_insert.php" type="button" class="btn btn-sm btn-outline-secondary">Insert Data</a>
                        </div>
                ...
                <div class="mt-2 table-responsive">
                    <table id="test" class="table table-striped table-sm">
                        ...
                        <tbody>
                            <?php
                            include "../conn.php";
                            $SQL = "SELECT * FROM users"; //sintak sql
                            $result = mysqli_query($koneksi, $SQL); //menjalankan sql
                            foreach ($result as $row) {
                                ...
                                echo ("<td>" . $row['users_alias'] . "</td>");
                                echo ('<td>');
                                echo ('<a href="users_update.php?id=' . $row["users_id"] . '"> Edit </a> ||');
                                echo ('<a href="users_delete.php?id=' . $row["users_id"] . '"> Hapus </a> ');
                                echo ('</td>');
                                echo ("</tr>");
                            }
                            ?>
