			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
				...
				<form action="types_process.php" method="POST" enctype="multipart/form-data">
					<div class="form-group row">
						<label for="tit" class="col-sm-2 col-form-label">Types ID</label>
						<div class="col-sm-10">
							<input type="text" name="id" class="form-control" id="id" placeholder="Masukan Type ID">
						</div>
					</div>
					<div class="form-group row">
						<label for="tit" class="col-sm-2 col-form-label">Types name</label>
						<div class="col-sm-10">
							<input type="text" name="type" class="form-control" id="type" placeholder="Masukan Type Nama">
						</div>
					</div>
